...
function Header({
  ...
  return (
    <header
      className={cn(
        "w-full bg-card px-4 py-3 border-b border-border rounded-b-lg flex items-center justify-between shadow-[0_5px_6px_-1px_rgb(0_0_0/0.25),0_3px_4px_-2px_rgb(0_0_0/0.15)] dark:shadow-[0_5px_6px_-1px_rgb(0_0_0/0.35),0_3px_4px_-2px_rgb(0_0_0/0.22)]",
